...
$files = [
    ...
    'vpn-text1' => '/opt/root/Bird4Static/lists/user-vpn1.list',
    'vpn-text2' => '/opt/root/Bird4Static/lists/user-vpn2.list',
    'isp-text' => '/opt/root/Bird4Static/lists/user-isp.list'
];
